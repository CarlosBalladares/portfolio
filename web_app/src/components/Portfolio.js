...
const portfolioData = [
  {
    ...
    title: "native-theme",
    desc:
      "An open source library that provides theming utilities. Can be used in any react-native projects",
    tech: ["react-native", "typescript", "npm"],
    demo: "https://www.npmjs.com/package/native-theme",
    source: "https://github.com/CarlosBalladares/native-theme",
  },
  {
    thumbnail: require("./../assets/autofica.png"),
    title: "Autofica",
    desc:
      "A marketing funnel for auto dealers. This project features a complex form that gathers data and sends emails. Built with amplify, serverless",
...

  {
    ...
    desc:
      "A website for an online music label. Connected sounds is an attempt to bring material design to music together.",
  ...
  },
  {
    ...
    desc:
      "A 3d scene rendered using ray tracing, Phong shading and other illumination models",
...

  {
    ...
    title: "Shader toys",
    desc:
      "These are textures generated procedurally in the fragment shader.I used webgl to accomplish this.",
    tech: ["Three.js", "WebGl", "Rendering"],
    demo: "https://raytracer3js.herokuapp.com/shaders/",
    source:
      "https://github.com/CarlosBalladares/webgl-raytracer/tree/master/public/shaders",
  },

  {
    ...
    desc:
      "This is a template for an imaginary travel agency website. It features pictures taken in the andes mountains",
    tech: ["HTML", "CSS", "JS"],
...

  {
    ...
    desc:
      "These are my solutions with detailed explanations for this problemset ",
    tech: ["C++", "Algorithms"],
    // demo:'https://connectedsoundsapp.herokuapp.com',
    source:
      "https://github.com/CarlosBalladares/Hackerrank-interview-preparation-kit-solutions",
  },

  {
    ...
    title: "Java Compiler",
    desc:
      "A Java compiler implemented with a teammate. This project was completed as part of CS411. It supports basic java syntax.",
...

  {
    ...
    desc:
      "A smartwatch data collection system. The app collects data from smartwatches and sends it to a sever for analysis.",
...

  {
    ...
    desc:
      "Simple proof of concept project to get acquainted with DASP. A gain controller implemented using the JUCE framework. A simple plugin",
    tech: ["DSP", "JUCE", "C++"],
    // demo:'https://connectedsoundsapp.herokuapp.com',
